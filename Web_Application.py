...
GaN_MMIC_image = Image.open('MMIC_Packaging.PNG')
...
def get_user_input():
    ...
    v_Adhe = st.sidebar.number_input("Poisson ratio's of adhesive", 0.350, 0.400, 0.370)
    ...
    v_Carr = st.sidebar.number_input("Poisson's ratio of carrier", 0.250, 0.350, 0.300)
...
st.write("#####")
st.write("##### Maximum von Mises stress in adhesive = {} MPa".format(Final_S_Adhe))
